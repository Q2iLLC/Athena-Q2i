module AthenaHealth
  module Endpoints
    module Patients
	  ...
	  def update_subscribed_patients(practice_id:, params: {})
        response = @api.call(
	  ...
	  def update_subscribed_patient_lab_results(practice_id:)
        response = @api.call(
	  ...
	  def update_subscribed_patient_appointments(practice_id:, params: {})
          response = @api.call(
      ...
      def get_patient_photo(practice_id:, patient_id:, params: {jpegoutput: true})
        @api.call(
            endpoint: "#{practice_id}/patients/#{patient_id}/photo",
            method: :get,
            params: params
